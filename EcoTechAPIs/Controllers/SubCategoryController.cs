...
namespace EcoTechAPIs.Controllers
{
    ...
    public class SubCategoryController : ControllerBase
    {
        ...
        {
            return uow.SubCategoryRepo.GetSubCategoryWithCategories().Where(c => c.CategoryID == id);
        }
        ...
        {
            return uow.SubCategoryRepo.GetSubCategoryWithCategories().Where(c => (id != null ? c.SubCategoryID == id : c.SubCategoryID == c.SubCategoryID));
        }
        #endregion
