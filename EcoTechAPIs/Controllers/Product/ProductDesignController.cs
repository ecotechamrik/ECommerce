...
namespace EcoTechAPIs.Controllers
{
    ...
    public class ProductDesignController : ControllerBase
    {
        ...
        {
            return uow.ProductDesignRepo.GetAll().Where(c => (id != null ? c.ProductDesignID == id : c.ProductDesignID == c.ProductDesignID));
        }
        #endregion
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] ProductDesign model)
        {
            try
            {
