...
namespace BAL
{
    public class SubCatGalleryAPIResponse: GenerateAPIResponse<SubCatGalleryViewModel>, ISubCatGalleryAPIResponse
    {
        ...
        public SubCatGalleryAPIResponse(IConfiguration _config) : base(_config)
        {
